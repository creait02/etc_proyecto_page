...
const translations = {
  en: {
    ...
    'footer.description': 'Award-winning architecture and interior design studio based in Caracas, creating spaces that inspire and endure.',
  ...
  es: {
    ...
    'footer.description': 'Estudio galardonado de arquitectura y diseño de interiores con sede en Caracas, creando espacios que inspiran y perduran.',
